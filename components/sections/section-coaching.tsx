    ...
    return (
        <Container className="flex flex-col gap-10">
            <div className="flex gap-20 justify-between">
                ...
                <div className="flex-1 max-w-[820px] bg-blue-200 rounded-[30px] py-16 px-24">
                    <TypoBody>
            ...
            <div className="flex gap-4">
                {COACHING_ITEMS.map((item, index) => (
                    <div key={`Coaching Item: ${index}`}
                         className="flex-1 bg-gray-200 rounded-[30px] py-12 px-6 font-bold flex flex-col items-center gap-6 text-center"
                    >
